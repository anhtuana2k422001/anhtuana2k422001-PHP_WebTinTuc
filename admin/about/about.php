								...
								<div class="col-lg-12">
									<div class="border border-3 p-4 rounded">
										...
										<div class="mb-3">
											...
											<textarea name="about_first_text" class="form-control" id="about_first_text" ><?php echo $about["about_first_text"] ?></textarea>
                                            <script>
                                                    tinymce.init({
                                                        selector: 'textarea',
										...
										<div class="mb-3">
											...
											<textarea name="about_second_text" class="form-control" id="about_second_text" ><?php echo $about["about_second_text"] ?></textarea>
										</div>
										...
										<div class="mb-3">
											...
											<textarea name="about_our_mission"  class="form-control" id="about_our_mission" rows="3"><?php echo $about["about_our_mission"] ?></textarea>
										</div>

										<div class="mb-3">
											<label for="about_our_vision" class="form-label">Tầm nhìn</label>
											<textarea name="about_our_vision" class="form-control" id="about_our_vision" rows="3"><?php echo $about["about_our_vision"] ?></textarea>
										</div>

										<div class="mb-3">
											<label for="about_services" class="form-label">Dịch vụ</label>
											<textarea name="about_services"  class="form-control" id="about_services" rows="3"><?php echo $about["about_services"] ?></textarea>
										</div>
