...
// phân trang
$total_records = Roles::GetTotalRecords();
...
$role = Roles::ListRoles($start, $limit);
?>
...
<head>
	...
	<!--plugins-->
    <title>Quản trị - Tất cả quyền</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            ...
                            <div class="ms-auto"><a href="createRole.php" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Thêm quyền mới</a></div>
                        </div>
